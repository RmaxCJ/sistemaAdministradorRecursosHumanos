...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><?php echo $textosArray[50];?></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    [correo] => adsegovia@rotoplas.com [num_empleado] => 10006833 [nombre] => Alejandro Daniel Segovia Ramirez [resetear_pass] => [division] => AR Buenos Aires [cod_division] => 1A01 [pais] => Argentina ) -->
            ...
            <?php if($_SESSION['id_perfil']==1){ ?>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <button class="paisBTN" id="Estados Unidos">
        ...
        <form style="display: none" action="listaconsecuencias" method="POST" id="formPais">
...
<script>
 ...
 function datossesion(){
    ...
    if(perfil!=1){
        window.location.href="listaconsecuencias";
    }
 }
